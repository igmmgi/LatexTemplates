...
dat <- createDF(nVP = 20, nTrl = 30,
                design = list("Comp" = c("Comp", "Incomp"),
                              "Side" = c("Left", "Right")))
dat <- addDataDF(dat,
                 RT = list(list(c("Comp:Comp",   "Side:Left"),  vals = c(500, 100, 150)),
                           list(c("Comp:Comp",   "Side:Right"), vals = c(520, 100, 150)),
                           list(c("Comp:Incomp", "Side:Left"),  vals = c(530, 100, 150)),
                           list(c("Comp:Incomp", "Side:Right"), vals = c(580, 100, 150))))
...
<<anova_table, echo=FALSE, results='asis'>>=
