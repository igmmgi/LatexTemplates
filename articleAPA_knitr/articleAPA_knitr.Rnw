...
dat <- addDataDF(dat,
                 RT = list("Comp:Side_Comp:Left" = c(500, 100, 150),
                           "Comp:Side_Comp:Right" = c(520, 100, 150),
                           "Comp:Side_Incomp:Left" = c(530, 100, 150),
                           "Comp:Side_Incomp:Right" = c(580, 100, 150)))
...
<<anova_table, echo=FALSE, include=FALSE >>=
